                ...
                c => new
                    {
                        ...
                        stripe_id = c.String(),
                        stripe_livemode = c.Boolean(nullable: false),
                        stripe_email = c.String(),
                        stripe_meta = c.String(),
                        card_id = c.String(),
                        card_last_four = c.Int(nullable: false),
                        card_exp_month = c.Int(nullable: false),
                        card_exp_year = c.Int(nullable: false),
